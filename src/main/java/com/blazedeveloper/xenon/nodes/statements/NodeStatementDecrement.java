...
public record NodeStatementDecrement(Token identifier) implements NodeStatement {
    @Override
    public String accept(NodeStatementVisitor visitor, int index) { return visitor.visit(this); }
}
